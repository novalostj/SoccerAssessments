...
namespace Quantum.Prototypes.Unity {
  ...
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.BallInstance))]
  public class BallInstance_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.BallInstance_Prototype> {
    [Quantum.LocalReference]
    public global::EntityPrototype instance;
    [Quantum.LocalReference]
    public global::EntityPrototype lastHolderRef;
    public Quantum.QBoolean bounceBack;
    public System.Int32 bouceBackForce;

    public sealed override Quantum.Prototypes.BallInstance_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.BallInstance_Prototype();
      converter.Convert(this.instance, out result.instance);
      converter.Convert(this.lastHolderRef, out result.lastHolderRef);
      result.bounceBack = this.bounceBack;
      result.bouceBackForce = this.bouceBackForce;
      return result;
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.GoalInstance))]
  public class GoalInstance_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.GoalInstance_Prototype> {
    [Quantum.LocalReference]
    public global::EntityPrototype ball;

    public sealed override Quantum.Prototypes.GoalInstance_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.GoalInstance_Prototype();
      converter.Convert(this.ball, out result.ball);
      return result;
    }
  }
  [System.SerializableAttribute()]
